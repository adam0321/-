    ...
    Private Sub BtnEnter_Click(sender As Object, e As EventArgs) Handles btnEnter.Click
        ...
        If (txtName.Text <> "" And txtPhone.Text <> "" And cmbDay.SelectedIndex <> -1 And cmbHour.SelectedIndex <> -1 And cmbMinute.SelectedIndex <> -1 And cmbMonth.SelectedIndex <> -1 And cmbYear.SelectedIndex <> -1) Then
            ...
            "',N'" & times.Replace("'", "''") & "')")
                    ...
                    Label10.Text = ""
                    Label9.Text = ""
                    點餐頁面.cmbDrink.SelectedIndex = 0
                    點餐頁面.cmbFood.SelectedIndex = 0
                    點餐頁面.cmbNum1.SelectedIndex = 0
                    點餐頁面.cmbNum2.SelectedIndex = 0
                    點餐頁面.cmbSpecial.SelectedIndex = 0
                    點餐頁面.cmbTemp.SelectedIndex = 0
                    cmbMonth.SelectedIndex = 0
                    cmbHour.SelectedIndex = 0
                    cmbDay.SelectedIndex = 0
                    cmbMinute.SelectedIndex = 0
